        ...
        <div class="container">
            ...
            <div class="card shadow mb-3">
                <div class="card-header py-3">
                    <p class="text-primary m-0 font-weight-bold">Create New Task</p>
                </div>
                <div class="card-body">
                    <form action="{{ route('todos.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row m-1">
                            <div class="col">
                                <div class="form-group"><label for="DeadLine"><strong>DeadLine</strong></label><input
                                        required class="form-control" type="date" name="deadline" min="{{date('Y-m-d')}}" value="{{date('Y-m-d')}}"></div>
                            </div>
                        </div>
                        ...
                        <div class="form-row m-1">
                            <div class="col">
                                <div class="form-group"><label for="topic" class="m-1"><strong>Topic</strong><br></label>
